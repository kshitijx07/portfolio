...
import { ArrowUpRight, ExternalLink, Layers, Terminal } from "lucide-react";
        ...
        {projects.map((project, idx) => (
          ...
          >
            ...
            <div
              ...
              className="lg:col-span-8 relative rounded-none border border-[var(--border-color)] bg-[var(--bg-surface)] overflow-hidden cursor-pointer group/img"
            >
