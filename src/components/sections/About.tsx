            ...
            <div className="max-w-6xl mx-auto">
                ...
                >
                    ...
                    <h2 className="text-3xl md:text-5xl font-bold mb-8 tracking-tight">
                        Engineering <span className="text-transparent bg-clip-text bg-gradient-to-r from-neutral-400 to-white">Digital Systems</span>
                    </h2>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-24">
                    {focusAreas.map((area, idx) => (
                        <motion.div
                            ...
                            className="glass-card p-8 rounded-2xl group hover:-translate-y-2 transition-all duration-500 hover:border-white/20"
                        >
                            <div className="w-14 h-14 rounded-full bg-white/5 flex items-center justify-center mb-6 group-hover:bg-white group-hover:text-black transition-colors duration-500">
                                <area.icon size={24} />
                            </div>
